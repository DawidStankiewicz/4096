var board = {
        ...
        getGrid: function () {
            let grid = new Array(board.cols);
            for (let x = 0; x < board.cols; x++) {
                grid[x] = new Array(board.rows);
            }

            board.fields.children.forEach(function (field) {
                grid[field.col][field.row] = field;
            });
            return grid;
        },
